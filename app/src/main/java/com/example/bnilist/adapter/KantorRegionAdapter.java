...
public class KantorRegionAdapter extends RecyclerView.Adapter<KantorRegionAdapter.RegionHolder> {

    Context context;
    public ArrayList<RegionModel> data;

    public KantorRegionAdapter(Context context, ArrayList<RegionModel> data){
        super();
