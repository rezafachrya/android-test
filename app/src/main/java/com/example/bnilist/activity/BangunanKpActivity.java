...
public class BangunanKpActivity extends AppCompatActivity {
    @BindView(R.id.rcKp)
    RecyclerView rcKp;
        ...
        spBangunan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(jnsSelected.toLowerCase().equals("Semua Jenis".toLowerCase())){
                    ...
                    for (AssetModel assetModel:getBuildings()){
                        if (assetModel.getJenis() != null){
                            if (jnsSelected.toLowerCase().equals(assetModel.getJenis().toLowerCase())){
                                tempJenisList.add(assetModel);
                            }
                        }
                    }
...
//        p.setListImage(getImage());
        ...
        a=new AssetModel();
        a.setNpa("110321");
        a.setNib("2005-723-1-8-000003");
        a.setKpa("Bukan Kantor");
        a.setNama("Tanah Kosong");
        a.setImg(arrImage1);
        a.setAlamat("Komplek Pesing BZ- Jelambar");
        a.setKelurahan("Wijaya Kusuma");
        a.setKecamatan("Grogol Petamburan");
        a.setKota("Jakarta Barat");
        a.setProvinsi("Jakarta");
        a.setKodepos("11460");
        a.setLuastanah("3.695");
        a.setLuasbangunan("-");
        a.setJml_lantai("-");
        a.setDoc_legal("SHGB No.3990");
        a.setNop("31.74.030.005.012-0638.0");
        a.setLongitude("-6.157508");
        a.setLatitude("106.769527");
        a.setJenis("Tanah");
        buildings.add(a);
